...
/*-----------------------------------------------------------------------------------*/
float _ITCMRAM_ approx_exp(float x)
{
...
float	_ITCMRAM_ Lin2Exp(uint8_t val, float min, float max)
{
	return min * powf(max / min, val / MIDI_MAX);
}
//------------------------------------------------------------------------------------

float _ITCMRAM_ tanhXdX(float x)
{
	float a = x*x;
...
//------------------------------------------------------------------------------------
float _ITCMRAM_ fastTanh(float var)
{
...
//------------------------------------------------------------------------------------
float 	_ITCMRAM_ softClipTwo(float in)
{
	return in * tanhXdX(0.5*in);
}
//------------------------------------------------------------------------------------
float 	_ITCMRAM_ fastTan(float x)
{
	float A = -15*x+x*x*x;
	float B = 3*(-5+2*x*x);
	return A/B;
