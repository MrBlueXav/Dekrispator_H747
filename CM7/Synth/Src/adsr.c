...
{
	env->attackRate_ = params->attackRate;
	env->decayRate_ = params->decayRate;
	env->sustainLevel_ = params->sustainLevel;
	env->releaseRate_ = params->releaseRate;
...
{
	params->attackRate = env->attackRate_;
	params->decayRate = env->decayRate_;
	params->sustainLevel = env->sustainLevel_;
	params->releaseRate = env->releaseRate_;
}
